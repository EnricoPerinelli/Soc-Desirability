...
% Arrows Cov I S
\draw[<->] (I) to[bend left=55] node[midway, above, font=\footnotesize, fill=white, inner sep=1pt] {$\varphi_{21}$} (S);
...
node[pos=0.5, above, font=\footnotesize, fill=white, inner sep=4pt] {$\varphi_{11}$}
($(I.west)+(0,-0.05)$);
...
node[pos=0.5, above, font=\footnotesize, fill=white, inner sep=4pt] {$\varphi_{22}$}
($(S.east)+(0,-0.05)$);
